...
(function() {
  ...
  },
  {
    ...
    "options": [
      ...
      "1 Enterprise core = 1 vCore in Business Critical or 8 vCores in General Purpose",
  ...
  // === IaaS Deployment (SQL Server on Azure VM) ===
  {
  ...
  },
  {
    ...
    "correct": 1,
    "module": 1,
    "explanation": "For vCore-based Azure SQL Database, retention is configurable from 1 to 35 days. The default is 7 days, but to recover to a point 14 days ago, they must configure retention to at least 14 days. For DTU model, retention is fixed: 7 days for Basic/Standard, 35 days for Premium."
  },
  {
  ...
  if (window.__dp300.modules.length < 1) {
    window.__dp300.modules[0] = "Module 1: Azure SQL Platform Options, Deployment & Migration";
  }
})();
